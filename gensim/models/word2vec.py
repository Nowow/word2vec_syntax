...
try:
    from gensim.models.word2vec_inner_synt import train_batch_sg, train_batch_cbow
    from gensim.models.word2vec_inner_synt import score_sentence_sg, score_sentence_cbow
    from gensim.models.word2vec_inner_synt import FAST_VERSION, MAX_WORDS_IN_BATCH
except ImportError:
...
class Word2Vec(utils.SaveLoad):
    ...
    def __init__(
            ...
            trim_rule=None, sorted_vocab=1, batch_words=MAX_WORDS_IN_BATCH, synt_cash = None):
        """
        ...
        if sentences is not None:
            ...
            self.train(synt_cash ,sentences)
    ...
    def _do_train_job(self, sentences, alpha, inits, synt_cash):
        """
        ...
        if self.sg:
            #insert synt_cash
            tally += train_batch_sg(self, sentences, alpha, work, synt_cash)
        else:
            tally += train_batch_cbow(self, sentences, alpha, work, neu1)
        return tally, self._raw_word_count(synt_cash)

    def _raw_word_count(self, job):
        """Return the number of words in a given job."""
        return sum(len(sentence) for sentence in job)
# TUT NE YASNO S PARAMETROM 4O
    def train(self, synt_cash, sentences, total_words=None, word_count=0,
        ...
        def worker_loop():
            ...
            while True:
                ...
                sentences, alpha = job
                #insert synt_cash
                tally, raw_tally = self._do_train_job(sentences, alpha, (work, neu1), synt_cash = synt_cash)
